            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="flex justify-center">
                    <div className="bg-white border rounded-lg shadow-md p-12 max-w-3xl text-center w-full">
                        ...
                        {isVerified ? (
                            <p className="text-xl mb-4">Your email has been verified. You will be redirected to the login page shortly.</p>
                        ) : (
                            <p className="text-xl mb-4">Please check your inbox and click the verification link to confirm your email address.</p>
                        )}
