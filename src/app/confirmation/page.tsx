    ...
    <div>
      ...
      <div className="container mx-auto p-4 flex justify-center items-center h-screen">
        <div className="bg-white shadow-md rounded p-8 max-w-md w-full text-center">
          ...
          <p className="mb-4">Thank you for ordering! Please enjoy {title}.</p>
          <p className="mb-4">Check your email for your order receipt. Your confirmation order number is:</p>
          <p className="font-mono text-lg mb-8">{orderNumber}</p>
          <Link href="/">
